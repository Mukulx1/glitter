...
var bb = () => {
  ...
  document.getElementById("holo").innerHTML="wait a second it's loading.....";
  

 setTimeout(()=>{
    var urlle = "https://wa.me/917876120415?text="
    +"*State anxiety :* "+score+"%0a"
    +"*Trait anxiety :* "+scores+"%0a"
    window.open(urlle,"_blank").focus();
 },4000)
 setTimeout(()=>{
